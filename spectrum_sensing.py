...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.train_button.setMinimumSize(QtCore.QSize(500, 0))
        self.train_button.setMaximumSize(QtCore.QSize(500, 16777215))
        self.train_button.setObjectName(_fromUtf8("train_button"))
        self.verticalLayout_4.addWidget(self.train_button, QtCore.Qt.AlignHCenter)
...
"Hidden Layers", None))
        ...
        self.learning_curve.setTitle(_translate("MainWindow", "Learning Curve", None))
